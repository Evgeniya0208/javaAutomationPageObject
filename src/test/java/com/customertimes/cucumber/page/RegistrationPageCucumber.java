...
import com.customertimes.pages.AbstractPage;
...
public class RegistrationPageCucumber extends AbstractPage {
    ...
    public WebElement getUserExistsErrorMessage() {
        wait.until(ExpectedConditions.attributeToBeNotEmpty(driver.findElement(userExistsErrorMessage), "innerText"));
    ...
    public void clickOnSecurityQuestion() {
        wait.until(ExpectedConditions.elementToBeClickable(this.securityQuestion));
